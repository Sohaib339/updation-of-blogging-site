...
export default function CategoryPage() {
  ...
  if (!cat) {
    return (
      <div className="main-content py-20 text-center">
        ...
        <Link to="/categories" className="px-6 py-3 bg-slate-800 text-white rounded-full font-bold hover:bg-slate-700 transition-colors inline-block">
          Browse Categories
        </Link>
      </div>
    );
  ...
  return (
    <div className="main-content py-8 md:py-10 pb-4 md:pb-6">
      {/* Breadcrumbs */}
